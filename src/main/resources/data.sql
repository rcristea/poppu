...
INSERT INTO movies VALUES (1005, 'Action', '2021:11:12', 'Dan Mazer', '1h 33m', true, 'Hutch Parker', 'PG', 3.5, 'A married couple tries to steal back a valuable heirloom from a troublesome kid.', 'Home Sweet Home Alone', 'TODO', 'TODO');
...
INSERT INTO movies VALUES (1007, 'Comedy', '2021:11:19', 'Casey Tebo', '1h 24m', true, 'Bruce Campbell', 'Unrated', 4.6, 'A group of toy store employees must protect each other from a horde of parasite infected shoppers.', 'Black Friday', 'TODO', 'TODO');
...
INSERT INTO movies VALUES (1008, 'Animation', '2021:11:24', 'Jared Bush', '1h 39m', true, 'Yvett Merino', 'PG', 7.8, 'A young Colombian girl has to face the frustration of being the only member of her family without magical powers.', 'Encanto', 'TODO', 'TODO');
...
INSERT INTO movies VALUES (1012, 'Animation', '2021:12:03', 'Swinton O. Scott III', '', false, 'Jeff Kinney', 'PG', 0.0, 'Greg Heffley is an ambitious kid with an active imagination and big plans to be rich and famous. The problem is that he has to survive middle school first.', 'Diary of a Wimpy Kid', 'TODO', 'TODO');
...
INSERT INTO movies VALUES (1013, 'Action', '2021:12:03', 'Denis Villeneuve', '2h 35m', false, 'Mary Parent', 'PG13', 8.2, 'Feature adaptation of Frank Herbert''s science fiction novel, about the son of a noble family entrusted with the protection of the most valuable asset and most vital element in the galaxy.', 'Dune', 'TODO', 'TODO');
...
INSERT INTO movies VALUES (1014, 'Comedy', '2021:12:10', 'Adam McKay', '2h 25m', false, 'Adam McKay', 'R', 0.0, 'Two low-level astronomers must go on a giant media tour to warn mankind of an approaching comet that will destroy planet Earth.', 'Don''t Look Up', 'TODO', 'TODO');
