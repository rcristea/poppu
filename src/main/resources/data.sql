...
INSERT INTO movies VALUES(1001, 'Action', '2021:09:07', 'Destin Cretton', true, 'Kevin Feige', 'PG13', 'Shang-Chi, the master of weaponry-based Kung Fu, is forced to confront his past after being drawn into the Ten Rings organization.', 'Shang-Chi and the Legend of the Ten Rings', 'HsX8pVqp_gg', 'assets/img/posters/shangchi_and_the_legend_of_the_ten_rings.jpeg',8.8,'2h 12m');
...
INSERT INTO movies VALUES(1002, 'Comedy', '2020:01:25', 'Alan Ball', true, 'Alan Ball', 'R', 'In 1973, when Frank Bledsoe and his 18-year-old niece Beth take a road trip from Manhattan to Creekville, South Carolina, for the family patriarch''s funeral, they''re unexpectedly joined by Frank''s lover, Walid.','Uncle Frank', 'K8nm0iYLvcs', 'assets/img/posters/uncle_frank.jpg',7.8,'1h 35m');
...
INSERT INTO movies VALUES (1003, 'Thriller', '2021:09:04', 'Cedric Nicolas-Troyan', true, 'Matt Levin', 'R','Slipped a fatal poison on her final job, a ruthless Tokyo assassin has less than 24 hours to find out who ordered the hit and exact revenge.', 'Kate', 'MysGjRS9jFU', 'assets/img/posters/kate.jpg',6.6,'1h 46m');
...
INSERT INTO movies VALUES (1004, 'Horror', '2021:08:13', 'Rodo Sayagues', true, 'Fede Álvarez', 'R', 'The sequel is set in the years following the initial deadly home invasion, where Norman Nordstrom (Stephen Lang) lives in quiet solace until his past sins catch up to him.', 'Don''t Breathe 2', 'gRbG2tjHYCA', 'assets/img/posters/dont_breathe_2.jpg',8.2,'1h 38m');
...
INSERT INTO movies VALUES (1005, 'Adventure', '2021:09:03', 'Kay Cannon', true, 'James Corden', 'PG', 'A modern movie musical with a bold take on the classic fairy tale. Our ambitious heroine has big dreams and with the help of her fab Godmother, she perseveres to make them come true.', 'Cinderella','20DF6U1HcGQ','assets/img/posters/cinderella_2021.jpg',1.5,'1h 53m');
...
INSERT INTO movies VALUES (1006,'Horror','2021:02:11','Alain Darborg',true,'Annika Sucksdorff','TVMA','When Nadja becomes pregnant, they make an attempt to rekindle their relationship by traveling to the north of Sweden for a hiking trip but soon their romantic trip turns into a nightmare.','Red Dot','t7FwypV69qc','assets/img/posters/red_dot.jpeg',5.7,'1h 26m');
...
INSERT INTO movies VALUES (1007,'Drama','2021:09:30','Castille Landon',false,'Hero Tiffin','R','Just as Tessa makes the biggest decision of her life, everything changes. Revelations about her family, and then Hardin''s, throw everything they knew before in doubt and makes their hard-won future together more difficult to claim.','After We Fell','NYdNN6C9hfI','assets/img/posters/after_we_fell.jpeg',5.4,'1h 36m');
...
INSERT INTO movies VALUES (1009,'Animation','2021:10:29','Kenji Nagasaki',false,'None','PG13','When a cult of terrorists ruins a city by releasing a toxin that causes people''s abilities to spiral out of control, Japan''s greatest heroes spread around the world in an attempt to track down the mastermind and put him to justice.','My Hero Academia: World Heroes'' Mission','6cBYUfAno-0','assets/img/posters/my_hero_academia_world_heroes_mission.png',6.6,'1h 44m');
...
INSERT INTO movies VALUES (1010,'Action','2021:12:22','Lana Wachowski',false,'Grant Hill','R','There is not a synopsis for this movie yet.','The Matrix Resurrections','9ix7TUGVYIo','assets/img/posters/the_matrix_resurrections.jpg',4.2,'2h 28m');
...
INSERT INTO movies VALUES (1011,'Action','2021:11:05','Chloé Zhao',false,'Kevin Feige','PG13','The saga of the Eternals, a race of immortal beings who lived on Earth and shaped its history and civilizations.','Eternals','x_me3xsvDgk','assets/img/posters/eternals.jpeg',7.5,'2h 36m');
...
INSERT INTO movies VALUES (1012,'Animation','2022:10:07','Joaquim Santos',false,'Phil Lord','Unrated','There is not a synopsis for this movie yet.','Spider-Man: Into the Spider-Verse 2','HsX8pVqp_gg','assets/img/posters/spider_man_into_the_spider_verse_2.jpeg',9.7,'');
